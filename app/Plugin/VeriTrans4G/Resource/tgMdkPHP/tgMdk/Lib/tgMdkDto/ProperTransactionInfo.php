...
class ProperTransactionInfo {
    ...
    */
     ...
     * 決済ゲートウェイ管理IDを設定する
     *
     * @param gatewayTransId 決済ゲートウェイ管理ID
     */
     ...
     *
     * @param alipayxResultCode Alipay+決済センター結果コード
     */
     ...
     *
     * @param alipayxRequestDatetime Alipay+決済センターへの要求日時
     */
     ...
     *
     * @param alipayxResponseDatetime Alipay+決済センターからの返戻日時
     */
