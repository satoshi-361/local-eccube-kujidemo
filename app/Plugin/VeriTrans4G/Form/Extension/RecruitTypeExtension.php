...
/**
 * リクルートかんたん支払い設定画面用フォーム拡張クラス
 */
class RecruitTypeExtension extends AbstractTypeExtension
{
    /**
     * コンテナ
     */
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if (!ExtensionUtil::hasPaymentId($Vt4gPaymentMethod, $this->vt4gConst['VT4G_PAYTYPEID_RECRUIT'])) {
            return;
        }
