 ...
 * 楽天ペイ設定画面用フォーム拡張クラス
 */
class RakutenTypeExtension extends AbstractTypeExtension
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if (!ExtensionUtil::hasPaymentId($Vt4gPaymentMethod, $this->vt4gConst['VT4G_PAYTYPEID_RAKUTEN'])) {
            return;
        }
        ...
        $builder
            ...
            ->add('result_mail_target', ChoiceType::class, [
                ...
                'required' => true,
                'expanded' => true,
                'choices' => $this->vt4gConst['VT4G_FORM']['CHOICES']['RESULT_MAIL_TARGET'],
                'label' => '要求結果メール送信対象',
                'constraints' => [
                    new NotBlank([
                        'message' => 'vt4g_plugin.validate.not_blank.choice'
                ...
                'mapped' => false,
                'data' => $savedData['result_mail_target'] ?? $this->vt4gConst['VT4G_FORM']['DEFAULT']['RESULT_MAIL_TARGET'],
            ])
