...
/**
 * ネットバンク支払設定画面用フォーム拡張クラス
 */
class BankTypeExtension extends AbstractTypeExtension
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if (!ExtensionUtil::hasPaymentId($Vt4gPaymentMethod, $this->vt4gConst['VT4G_PAYTYPEID_BANK'])) {
            return;
        }
        ...
        $builder
            ...
            ->add('mailTiming', ChoiceType::class, [
                'attr' => [
                    'class' => 'vt4g_from_input_choice',
                ],
                'expanded' => true,
                'choices' => $this->vt4gConst['VT4G_FORM']['CHOICES']['MAIL_TIMING'],
                'label' => '注文完了メール送信タイミング',
                'mapped' => false,
                'constraints' => [
                    new NotBlank(
                        [
                ...
                'data' => $savedData["mailTiming"] ?? $this->vt4gConst['VT4G_FORM']['DEFAULT']['MAIL_TIMING'],
            ])
