...
/**
 * 銀聯ネット決済設定画面用フォーム拡張クラス
 */
class UpopTypeExtension extends AbstractTypeExtension
{
    /**
     * コンテナ
     */
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if (!ExtensionUtil::hasPaymentId($Vt4gPaymentMethod, $this->vt4gConst['VT4G_PAYTYPEID_UPOP'])) {
            return;
        }
