 ...
 * 携帯キャリア決済の決済処理を行うクラス.
 */
class Career extends AbstractController implements PaymentMethodInterface
{
    /**
     * @var Order
     */
    ...
    public function apply()
    {
        ...
        if ($this->Order->getPaymentTotal() > 0) {
            //決済画面へ
            $response = new RedirectResponse($this->router->generate('paygent_payment/payment_career'));
