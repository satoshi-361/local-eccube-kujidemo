...
/**
 * 携帯キャリア決済受注管理操作オーソリ・売上変更処理クラス
 */
class CareerOperationChangeService extends CareerOperationService {
    ...
    public function process($paygentType, $orderId, $paymentId = '', $beforeStatus = '')
    {
        ...
        $kind = $arrPaygentKind['paygent_career_commit_revice'];
        ...
        // $arrSendに補正金額を付け加える
        $arrSend['amount'] = (int)$order[0]->getTotal();
