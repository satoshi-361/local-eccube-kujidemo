...
class ForgotController extends AbstractController
{
    ...
    public function reset(Request $request, $reset_key)
    {
        ...
        if (null !== $Customer->getBirth()) 
          $form->setData(['birth' => $Customer->getBirth()]);
     ...
     * パスワード再発行.
     *
     * @Route("/administrator/reset/{id}", name="admin_reset")
     */
    public function adminReset(Request $request, $id = null)
    {
        if ( isset($id) ) {
            ...
            if (!is_null($Customer)) {
                ...
                log_warning(
                    'Unactive customer try send reset password email: ',
                    ['Enter email' => $form->get('login_email')->getData()]
                );
            }
        } else {
     ...
     * 一括でパスワード再発行.
     *
     * @Route("/administrator/all_reset/", name="admin_all_reset")
     */
    public function adminAllReset(Request $request)
    {
